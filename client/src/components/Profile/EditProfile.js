...
const EditProfile = ({ open, onClose, userProfile, onSave }) => {
  ...
  useEffect(() => {
    setFormData(userProfile); // Update form data when user profile changes
  }, [userProfile]);
  ...
  const handleSubmit = () => {
    onSave(formData); // Save updated data and close the dialog
  };
    ...
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="md">
      ...
      <DialogContent sx={{ paddingTop: 2 }}>
        ...
        <FormControl fullWidth margin="normal">
          ...
          <Select
            name="preferCampus"
            value={formData.preferCampus}
            onChange={handleChange}
            label="Prefer Close to Campus"
          >
        ...
        {/* New Fields: Study Habits, Cooking, Allergies, Familiar with the City, Looking for New Friends */}
        <FormControl fullWidth margin="normal">
        ...
        <FormControl fullWidth margin="normal">
          ...
          <Select
            value={formData.familiarWithCity}
            onChange={handleChange}
            label="Familiar with the City"
            name="familiarWithCity"
          >
            <MenuItem value="Y">Yes</MenuItem>
            <MenuItem value="N">No</MenuItem>
          </Select>
        ...
        <FormControl fullWidth margin="normal">
          ...
          <Select
            value={formData.newFriends}
            onChange={handleChange}
            label="Looking for New Friends"
            name="newFriends"
          >
            <MenuItem value="Y">Yes</MenuItem>
            <MenuItem value="N">No</MenuItem>
